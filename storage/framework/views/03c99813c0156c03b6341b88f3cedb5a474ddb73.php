...
<html>
    <head>
        ...
        <title>
             <?php echo dujiaoka_config_get('rjtitle'); ?>
     ...
     <div class="box">
        ...
        <div class="toggle" data-state="visible">
            <svg xmlns="http://www.w3.org/2000/svg" class="eye" width="32" height="32">
               ...
               <?php if(dujiaoka_config_get('is_open_pass') == \App\Models\BaseModel::STATUS_OPEN): ?>
       <input type="password" id="password" placeholder="请输入密码<?php echo e(dujiaoka_config_get('cnpass'), false); ?>">
     <?php else: ?>
    ...
    function submitPassword() {
       ...
       if (password === '<?php echo dujiaoka_config_get('cnpass'); ?>'){
            document.querySelector('.loader').style.display = "block";
            work('<?php echo e($code, false); ?>').then(output => {
...
<?php /**PATH /www/wwwroot/imraneditz.org/resources/views/common/challenge.blade.php ENDPATH**/ ?>