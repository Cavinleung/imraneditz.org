...
<?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="<?php echo e(Auth::user()->email, false); ?>" disabled>
                    <?php else: ?>
        ...
        $.ajax({
            ...
            success: function(data) {
                initGeetest({
                    ...
                    lang: '<?php echo e(dujiaoka_config_get('language') ?? 'zh_CN', false); ?>',
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('hyper.layouts.seo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/imraneditz.org/resources/views/hyper/static_pages/buy.blade.php ENDPATH**/ ?>