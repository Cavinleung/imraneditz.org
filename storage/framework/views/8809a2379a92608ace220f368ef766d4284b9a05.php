...
TkSuQmCC" />
    ...
    <h2>独角数卡 「<?php echo e(config('dujiaoka.dujiaoka_version'), false); ?>」</h2>
    <div>

        <p>每个梦想的路上，一起前行....！
            <a href="https://t.me/fakagege" id="qq-group-link" target="_blank">
                👉🏻此程序是二次开发版
            </a>
        </p>
...
<?php /**PATH /www/wwwroot/imraneditz.org/resources/views/common/install.blade.php ENDPATH**/ ?>