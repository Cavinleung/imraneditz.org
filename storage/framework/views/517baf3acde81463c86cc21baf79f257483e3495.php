...
<div class="row mt-3">
            ...
            <div class="card-body affiliate-overview">
                <div class="card p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="h4 m-0"><?php echo e($invite_count, false); ?></div>
                ...
                <div class="card p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="h4 m-0"><?php echo e($invite_amount, false); ?></div>
    ...
    <div class="col col-lg-3">
        <div class="card">
            ...
            <div class="card-body contact"><p><?php echo dujiaoka_config_get('gonggao_text'); ?></p></div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link <?php if($type === 'invite'): ?> active <?php endif; ?>" href="<?php echo e(url('/user/invite'), false); ?>">返利记录</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($type === 'withdraw'): ?> active <?php endif; ?>" href="<?php echo e(url('/user/invite/withdraw'), false); ?>">提现记录</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="table-responsive invite-table">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td scope="row"><?php echo e($order->id, false); ?></td>
                               <td><?php echo e($order->order ? \App\Service\Util::CryptoMail($order->order->email) : '无邮箱信息', false); ?></td>
                                <td class="text-primary">￥<?php echo e($order->amount, false); ?></td>
                                <td>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-primary">￥<?php echo e($order->amount, false); ?></td>
                                <?php if($order->type === 2): ?>
                                <td class="show-address"><?php echo e(\App\Service\Util::WithdrawAccount($order->account), false); ?></td>
                                <?php else: ?>
                                <td class="show-address">转余额</td>
                                <?php endif; ?>
                                <td class="show-address"><?php echo e($order->address, false); ?></td>
                                <td>
                                    <?php if($order->status === 1): ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group copy-input">
                            <input name="share-link" class="form-control" type="text" readonly=""
                                   value="<?php echo e(config('app.url'), false); ?>?aff=<?php echo e(Auth::user()->invite_code, false); ?>"><span
                                class="input-group-append">
                                <button class="btn btn-primary"
                                        onclick="copyLink('<?php echo e(config('app.url'), false); ?>?aff=<?php echo e(Auth::user()->invite_code, false); ?>')">
                                    <i class="uil uil-copy"></i>复制</button></span>
                        </div>
                    </div>
                    <div class="form-group"><label class="form-label">活动规则</label>
                        <?php echo dujiaoka_config_get('guize_text'); ?>
                ...
                <div class="withdrowal-setting">
                    <div class="account">
                        ...
                        <div class="form-wrapper account-name">
                            <div class="mb-2"><span style="font-size: 18px;font-weight: bold;color: #000;">￥<?php echo e($invite_amount, false); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="desc"><h4>提现说明:</h4>
                        <?php echo dujiaoka_config_get('tixian_text'); ?>
...
<script>
    ...
    function onSubmit() {
        ...
        if (param.type === 'withdraw' && param.address === ''){
            $.NotificationApp.send("<?php echo e(__('hyper.buy_warning'), false); ?>","请输入提现账户地址！","top-center","rgba(0,0,0,0.2)","info");
            return false;
        }
        $.post("/user/withdraw", param, function (res) {
            if (res.code) {
                ...
                $.NotificationApp.send("<?php echo e(__('hyper.buy_warning'), false); ?>",res.message,"top-center","rgba(0,0,0,0.2)","info");
            }
        })
    }
</script>
...
<?php echo $__env->make('hyper.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/ek.zzfw.xyz/resources/views/kphyper/static_pages/invite.blade.php ENDPATH**/ ?>