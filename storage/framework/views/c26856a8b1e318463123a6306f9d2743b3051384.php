<div class="">
    ...
    <section>
        <h4 class="page-header header-title">40 Icons in 4.3 </h4>
    ...
    <section id="new-icons">
        <h4 class="page-header header-title">40 Icons in 4.2</h4>
        <div class="icon-list-demo row">
    ...
    <section id="web-application">
        <h4 class="page-header header-title">Web Application</h4>
        <div class="icon-list-demo row">
    ...
    <section id="file-type">
        <h4 class="page-header header-title">File Type Icons</h4>
    ...
    <section id="spinner">
        <h4 class="page-header header-title">Spinner Icons</h4>
    ...
    <section id="currency">
        <h4 class="page-header header-title">Currency Icons</h4>
    ...
    <section id="directional">
        <h4 class="page-header header-title">Directional Icons</h4>
    ...
    <section id="brand">
        <h4 class="page-header header-title">Brand Icons</h4>
    ...
    <section id="medical">
        <h4 class="page-header header-title">Medical Icons</h4>
...
</div><?php /**PATH /www/wwwroot/imraneditz.org/vendor/dcat/laravel-admin/src/../resources/views/helpers/font-awesome.blade.php ENDPATH**/ ?>